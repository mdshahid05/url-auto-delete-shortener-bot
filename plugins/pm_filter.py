...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡MCU CHANNEL⚡", url='https://t.me/mcuinfinitysaga')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 MCU CHANNEL 🤖', url='https://t.me/mcuinfinitysaga')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ SUPPORT ⚡", url='https://t.me/suppor012')
        ]
    )
