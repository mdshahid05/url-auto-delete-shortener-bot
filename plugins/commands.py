...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/mcuinfinitysaga')
            ],
            [
                InlineKeyboardButton('⚡ SUPPORT ⚡', url=f"https://t.me/suppor012"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUPPORT ⚡', url='https://t.me/suppor012'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/mcuinfinitysaga')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('GROUP', url='https://t.me/movierequstgroup7') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
